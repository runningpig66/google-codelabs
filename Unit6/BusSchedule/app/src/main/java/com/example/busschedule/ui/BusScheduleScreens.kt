...
import com.example.busschedule.ui.utils.PhonePreviews
...
fun BusScheduleApp(
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(route = BusScheduleScreens.FullSchedule.name) {
                FullScheduleScreen(
                    busSchedules = fullSchedule,
                    contentPadding = innerPadding,
                    onScheduleClick = { stopName ->
                        navController.navigate("${BusScheduleScreens.RouteSchedule.name}/$stopName")
            ...
            composable(
                ...
                arguments = listOf(navArgument(busRouteArgument) {
