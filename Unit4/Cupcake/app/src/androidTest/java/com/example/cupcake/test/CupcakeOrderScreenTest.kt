...
class CupcakeOrderScreenTest {
    ...
    fun selectOptionScreen_verifyContent() {
        ...
        composeTestRule.onNodeWithStringId(R.string.subtotal_price, subtotal).assertIsDisplayed()
    ...
    fun summaryScreen_verifyContentDisplay() {
        ...
        composeTestRule.onNodeWithStringId(R.string.subtotal_price, fakeOrderUiState.price).assertIsDisplayed()
    }
}
